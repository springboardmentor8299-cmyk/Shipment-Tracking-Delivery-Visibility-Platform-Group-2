...
import { getAllUsers, createStaffUser } from "../services/userService";
    ...
    <div className="table-card">
      <div className="table-header">
        ...
        <div className="table-actions">
          {onCreateClick && (
            <button className="add-btn" onClick={onCreateClick}>
              <span className="btn-icon">+</span> Create Staff
            </button>
          )}
              ...
              currentItems.map((u) => {
                ...
                return (
                  <tr key={u.id}>
                    ...
                    <td>
                      <span
                        className={`role-badge role-${u.role?.toLowerCase().replace(/_/g, "-")}`}
                      >
...
function UsersTable() {
  ...
  const handleCreateStaff = async (staffData) => {
    await createStaffUser(staffData);
